...
public class VerseDeviceGenerator
{
    ...
    public VerseDeviceGenerator(ForgeConfig config, ILogger<VerseDeviceGenerator> logger)
    {
        _config = config;
        _logger = logger;
    }
    ...
    private string GenerateGameManager(VerseFileRequest request)
    {
        ...
        b.Comment("Game Manager — Generated by FortniteForge");
    ...
    private string GenerateTimerController(VerseFileRequest request)
    {
        ...
        var b = new VerseCodeBuilder();
        b.Comment("Timer Controller — Generated by FortniteForge");
    ...
    private string GenerateTeamManager(VerseFileRequest request)
    {
        ...
        var b = new VerseCodeBuilder();
        b.Comment("Team Manager — Generated by FortniteForge");
    ...
    private string GenerateEliminationTracker(VerseFileRequest request)
    {
        ...
        var b = new VerseCodeBuilder();
        b.Comment("Elimination Tracker — Generated by FortniteForge");
    ...
    private string GenerateCollectibleSystem(VerseFileRequest request)
    {
        ...
        var b = new VerseCodeBuilder();
        b.Comment("Collectible System — Generated by FortniteForge");
    ...
    private string GenerateZoneController(VerseFileRequest request)
    {
        ...
        var b = new VerseCodeBuilder();
        b.Comment("Zone Controller — Generated by FortniteForge");
    ...
    private string GenerateMovementMutator(VerseFileRequest request)
    {
        ...
        var b = new VerseCodeBuilder();
        b.Comment("Movement Mutator — Generated by FortniteForge");
    ...
    {
        var b = new VerseCodeBuilder();
        b.Comment($"{request.ClassName} — Generated by FortniteForge");
